        ...
        <div className="container landing-container">
            <div className="row">
                <div className="col-lg-4">
                    ...
                    <h1 className='text-light'>My<span className="text-primary">Jobs</span></h1>
                    <br />
                    <Link to='/login' className="btn btn-primary px-4 py-2">Get started</Link>
                </div>
                <div className="col-lg-8">
                    <img className="img-fluid rounded lady-img" src={lady} alt="working lady" />
                </div>
            </div>
            <div>
            ...
            <div className="row">
                ...
                <div className="col-lg-4 p-4 card">
                    ...
                    <p className="text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga alias, quos nemo quas harum sequi. </p>
                </div>
                <div className="col-lg-4 p-4 card">
